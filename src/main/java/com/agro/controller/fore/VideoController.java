package com.agro.controller.fore;
...
import com.agro.service.impl.WebSocket;
...
//        webSocket.sendMessage("新视频："+video.getTitle()+" 待审核");
    ...
    public ServerResponse getChecklist(@RequestParam(value = "page",defaultValue = "1") Integer page, @RequestParam(value = "limit",defaultValue = "20") Integer limit,String name){
    ...
    public ServerResponse getNopasslist(@RequestParam(value = "page",defaultValue = "1") Integer page, @RequestParam(value = "limit",defaultValue = "20") Integer limit,String name){
        if (!StringUtils.isEmpty(name)){
    ...
    public ServerResponse getAlllist(@RequestParam(value = "page",defaultValue = "1") Integer page, @RequestParam(value = "limit",defaultValue = "100") Integer limit,String name){
        if (!StringUtils.isEmpty(name)){
